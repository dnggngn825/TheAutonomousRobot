...
int main(int argc, char* argv[])
{
    ...
    publisher_4_system_control_timer = nd.advertise<std_msgs::UInt32>(amr_topic::TIMER_4_SYSTEM_CONTROL, 10, false);
    publisher_4_motor_control_timer = nd.advertise<std_msgs::UInt32>(amr_topic::TIMER_4_MOTOR_CONTROL, 10, false);
    ...
    subscriber_test = nd.subscribe(amr_topic::TIMER_4_MOTOR_CONTROL, 1, selfSubscriberCallback);
    subscriber_test = nd.subscribe(amr_topic::TIMER_4_SYSTEM_CONTROL, 1, selfSubscriberCallback);
...
// ==================================================
/**
 * @brief Functionality: subscribe to show the published messages of 2 timer callbacks.
 * @param msg message
 */
