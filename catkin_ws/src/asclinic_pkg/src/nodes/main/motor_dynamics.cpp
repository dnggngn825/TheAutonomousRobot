...
// WHEEL MOTOR CONTROL: Specify the various limits
...
PCA9685 m_pca9685_servo_driver (&m_i2c_driver, AMR_PCA9685_ADDRESS);
...
int main(int argc, char* argv[])
{
	...
	initialise_servo(AMR_PCA9685_FREQUENCY);
...
uint16_t clip_pulse_width_in_us(uint16_t pulse_width_in_us)
{
	...
	{
		if (pulse_width_in_us < PCA9685_PULSE_MIN)
			pulse_width_in_us = PCA9685_PULSE_MIN;
		if (pulse_width_in_us > PCA9685_PULSE_MAX)
			pulse_width_in_us = PCA9685_PULSE_MAX;
	}
