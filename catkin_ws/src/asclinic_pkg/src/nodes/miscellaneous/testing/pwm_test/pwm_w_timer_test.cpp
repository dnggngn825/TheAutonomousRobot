...
//
// $ rostopic pub -once asclinic_pkg/motor_pwm_duty_cycle MotorAngularVelocityPWM '{pwm_duty_cycle_motor_l: 10, pwm_duty_cycle_motor_r:10}'
...
{
	ros::init(argc, argv, "pwm_w_timer_test");
...
void subscriberCallbackForMotorPwmDutyCycle(const MotorAngularVelocityPWM& msg)
{
	...
	ROS_INFO_STREAM("[MOTOR CONTROLLER] Message receieved with data = " << pwm_duty_cycle_motor_l << " ; " << pwm_duty_cycle_motor_r);
