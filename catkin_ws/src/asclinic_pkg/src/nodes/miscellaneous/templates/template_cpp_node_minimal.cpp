...
int main(int argc, char* argv[])
{
	...
	m_template_publisher = n.advertise<std_msgs::UInt32>("great_topic", 10, false);
	// Initialise a timer
	m_timer_for_publishing = n.createTimer(ros::Duration(1.0), timerCallbackForPublishing, false);
	// Initialise a subscriber
	ros::Subscriber template_subscriber = n.subscribe("great_topic", 1, templateSubscriberCallback);
