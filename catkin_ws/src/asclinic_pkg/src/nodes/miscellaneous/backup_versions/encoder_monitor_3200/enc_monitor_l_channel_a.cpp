...
{
	// Initialise the node
	ros::init(argc, argv, amr_node::ENC_MONITOR_L_CHANNEL_A);
	ros::NodeHandle nd;

    publisher_enc_state = nd.advertise<amr_msgs::EncLineState>(amr_topic::ENC_L_CHANNEL_A_STATE, 10, false);
	...
	msg.data = gpiod_ctxless_get_value(AMR_GPIO_CHIP_NAME, AMR_ENCODER_PIN_CHANNEL_A_MOTOR_L, false, "foobar");
