...
int main(int argc, char* argv[])
{
    ...
    ros::Subscriber subscriber_4_motor_l = nd.subscribe(amr_topic::ENCODER_DATA_4_ODOMETRY_CONTROL_L, 10, subscriberCallbackForMotorLeft);
    ros::Subscriber subscriber_4_motor_r = nd.subscribe(amr_topic::ENCODER_DATA_4_ODOMETRY_CONTROL_R, 10, subscriberCallbackForMotorRight);
