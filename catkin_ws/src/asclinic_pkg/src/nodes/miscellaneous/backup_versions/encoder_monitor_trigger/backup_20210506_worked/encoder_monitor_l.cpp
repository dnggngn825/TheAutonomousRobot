...
int main(int argc, char* argv[])
{
	...
	// publisher_4_motor_control = nd.advertise<std_msgs::Int16>(amr_topic::ENCODER_DATA_4_MOTOR_CONTROL_L, 10, false);
    // publisher_4_odometry_control = nd.advertise<std_msgs::Int16>(amr_topic::ENCODER_DATA_4_ODOMETRY_CONTROL_L, 10, false);
