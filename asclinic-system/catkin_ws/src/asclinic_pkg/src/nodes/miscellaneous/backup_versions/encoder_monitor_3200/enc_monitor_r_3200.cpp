...
{
	// Initialise the node
	ros::init(argc, argv, amr_node::ENC_MONITOR_R_3200);
	ros::NodeHandle nd;
	...
	ros::Subscriber subsciber_channel_a_trigger_eventtype = nd.subscribe(amr_topic::ENC_R_CHANNEL_A_STATE, 1, subscriberCallback4ChannelATriggerEventtype); 
	ros::Subscriber subsciber_channel_b_trigger_eventtype = nd.subscribe(amr_topic::ENC_R_CHANNEL_B_STATE, 1, subscriberCallback4ChannelBTriggerEventtype); 
