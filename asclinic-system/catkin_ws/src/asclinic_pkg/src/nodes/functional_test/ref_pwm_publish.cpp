...
// int pwm_duty_cycle_motor_l[] = {10,10, 10, 0};
// int pwm_duty_cycle_motor_r[] = {10,10, 10, 0};

// int pwm_duty_cycle_motor_l[] = {10, 0};
// int pwm_duty_cycle_motor_r[] = {10, 0};

int pwm_duty_cycle_ref = 10;
int pwm_duty_cycle_motor_l[] = {pwm_duty_cycle_ref*AMR_DIRECTION_CW_MOTOR_L, 0};
int pwm_duty_cycle_motor_r[] = {pwm_duty_cycle_ref*AMR_DIRECTION_CW_MOTOR_R, 0};

// int pwm_duty_cycle_motor_l[] = {pwm_duty_cycle_ref*AMR_DIRECTION_CW_MOTOR_L, pwm_duty_cycle_ref*2*AMR_DIRECTION_CW_MOTOR_L, pwm_duty_cycle_ref*3*AMR_DIRECTION_CW_MOTOR_L, 0};
// int pwm_duty_cycle_motor_r[] = {pwm_duty_cycle_ref*AMR_DIRECTION_CW_MOTOR_R, pwm_duty_cycle_ref*2*AMR_DIRECTION_CW_MOTOR_R, pwm_duty_cycle_ref*3*AMR_DIRECTION_CW_MOTOR_R, 0};
